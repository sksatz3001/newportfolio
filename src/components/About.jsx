            ...
            <div className='bg-gray-100 py-12'>
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                    <div className='text-center'>
                        ...
                        <p className='mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl'>Hi, I'm Sathish Kumar</p>
                    ...
                    <div className='mt-10'>
                        <div className='grid grid-cols-1 gap-12 lg:grid-cols-2'>
                            <div>
                                ...
                                I bring over 5 years of professional experience in web development, specializing in cutting-edge technologies like React.js, Next.js, Node.js, and Tailwind CSS to create high-performing, scalable applications. I also have extensive expertise in CMS platforms like WordPress and Shopify, delivering custom solutions that blend functionality with seamless design. My diverse skill set enables me to handle projects ranging from full-stack development to e-commerce platforms, ensuring tailored results that exceed client expectations.
                                </p>
