        ...
        <div className='flex flex-col md:flex-row justify-between items-center'>
            <div className='md:w-1/2 mb-8 ml-2 md:mb-0'>
              ...
              <div className='flex space-x-4'>
                ...
                <a href="https://www.instagram.com/sk_satz_iam/profilecard/?igsh=ZG5pd2FoNGJoN3I5" target='_blank' className='text-foreground/60 hover:text-foreground/80'>
                <img src={instagram} alt="" className='h-6 w-6'/></a>
                <a href=" https://www.linkedin.com/in/sathish-kumar-s-980aa3157" target='_blank' className='text-foreground/60 hover:text-foreground/80'>
                <img src={linkedin} alt="" className='h-6 w-6'/></a>
              </div>
                <Lottie animationData={contact} className='w-[350px] mx-auto lg:w-[500px]'/>
            </div>
            <form  action="https://formspree.io/f/mkgnzrrk"  method="POST" className='w-full md:w-1/2 bg-gray-100 rounded-lg border border-red-300 shadow-lg shadow-red-500 p-10'> 
